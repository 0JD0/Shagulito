    ...
    rows.forEach(function(row){
        content += `
            <tr>
                ...
                <td><i class="material-icons">${(row.produccion == 1) ? 'check' : 'clear'}</i></td>
                <td><i class="material-icons">${(row.usuarios == 1) ? 'check' : 'clear'}</i></td>
                <td><i class="material-icons">${(row.transacciones == 1) ? 'check' : 'clear'}</i></td>
                <td><i class="material-icons">${(row.reportes == 1) ? 'check' : 'clear'}</i></td>
                <td><i class="material-icons">${(row.graficos == 1) ? 'check' : 'clear'}</i></td>
                <td>
                    <a href="#" onclick="modalUpdate(${row.id_cargo})" class="blue-text waves-effect waves-blue tooltipped" data-tooltip="Modificar"><i class="material-icons">edit</i></a>
                    <a href="#" onclick="confirmDelete(${row.id_cargo})" class="red-text waves-effect waves-orange tooltipped" data-tooltip="Eliminar"><i class="material-icons">delete</i></a>
                </td>
            </tr>
        `;
    });
