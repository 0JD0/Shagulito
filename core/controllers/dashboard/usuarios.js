    ...
    rows.forEach(function(row){
        ...
        content += `
            <tr>
                ...
                <td>
                    <a href="#" onclick="modalUpdate(${row.id_empleado})" class="tooltipped" data-tooltip="Modificar"><i class="material-icons blue-text">mode_edit</i></a>
                    <a href="#" onclick="confirmDelete(${row.id_empleado}, '${row.foto_empleado}')" class="tooltipped" data-tooltip="Eliminar"><i class="material-icons red-text">delete</i></a>
                </td>
            </tr>
        `;
    });
