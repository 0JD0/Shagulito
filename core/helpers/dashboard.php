...
class Dashboard
{
    public static function headerTemplate($title)
    {
        ...
        if (isset($_SESSION['id_empleado'])) {
			//print_r($_SESSION);
			if (time() - $_SESSION['timestamp'] > 1200) { //tiempo de cierre de sesión por segundos
            ...
            if ($filename != 'index.php' && $filename != 'register.php' && $filename != 'cambiocontra.php') {
				...
				if ($_SESSION['permisos']['produccion']) {
					$menu .= '
					<li>
						<a class="collapsible-header">Producción</a>
				...
				if ($_SESSION['permisos']['usuarios']) {
					$menu .= '
					<li>
						<a class="collapsible-header">Usuarios</a>
						<div class="collapsible-body">
							<ul>
								<li>
									<a href="usuarios.php">
				...
				if ($_SESSION['permisos']['transacciones']) {
					$menu .= '
						<li>
							<a class="collapsible-header">Transacciones</a>
							<div class="collapsible-body">
								<ul>
									<li>
										<a href="ventas.php">
				...
				if ($_SESSION['permisos']['reportes']) {
					$menu .= '
					<li class="no-padding">
						<a class="collapsible-header" href="reportes.php"><span class="black-text">Reportes</span></a>
					</li>';
				} else {
				...
				if ($_SESSION['permisos']['graficos']) {
					$menu .= '
					<li class="no-padding">
						<a class="collapsible-header" href="graficos.php"><span class="black-text">Gráficos</span></a>
					</li>';
				} else {
                ...
                print('
					...
					<!--El menu desplegable-->
						<ul id="slide-out" class="sidenav collapsible">
							...
							<li class="no-padding">
								<a href="home.php" class="collapsible-header">Inicio</a>
							</li>
							'.$menu.'
							<li>
