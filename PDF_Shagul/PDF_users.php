...
// Cabecera de la pgaina del reporte
    function Header(){
      $this->image('logo.png',10,10,30);
        ...
        // Titulo
        $this->Cell(100,20,'panaderia shagulito: usuarios',0,0,'C');
        // Salto de linea
        $this->Ln(20);
        ...
        $this->Cell(30,10,utf8_decode('Alias usuario'),1,0,'C',0);
        $this->Cell(30,10,utf8_decode('id usuario'),1,1,'C',0);
    }
...
while ($row = $result->fetch_assoc()) {
    ...
    $pdf->Cell(40,10,$row['apellido_empleado'],1,0,'C',0);
    $pdf->Cell(40,10,$row['correo_empleado'],1,0,'C',0);
    $pdf->Cell(30,10,$row['alias_empleado'],1,0,'C',0);
