<?php
require('../libraries/fpdf181/fpdf.php'); //AQUI  INCLUIMOS EL ARCHIVO PHP QUE ARMARÁ NUESTRO PDF
...
Class PDF extends fpdf
{
    function Header()
    {
        ...
        $this->Cell(140,10, 'Datos : '.$array_alumnos[1].' '.$array_alumnos[2].' ',0,0,'L');  //MOSTRAMOS DICHOS DATOS
